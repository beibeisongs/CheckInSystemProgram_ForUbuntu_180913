...
def startSaveExtractedJPG(jpg_dirpath, whole_jpg_path, class_name, name, d, pic_file_type):
    """
    ...
    """Attention:
        ...
        <Sample>:new_jpg_name = class_name + '_' + name + "_signup_1." + pic_file_type

    """
    new_jpg_name = class_name + '_' + name + "_signup_1." + pic_file_type
...
def ExtractFaceInsideJPG_Process(detector, jpg_dirpath, whole_jpg_path, class_name, name, pic_file_type):
    ...
    if num_of_faces > 0:
        ...
        for k, d in enumerate(dets):
            if process_1_i == MAX_i:
                startSaveExtractedJPG(jpg_dirpath, whole_jpg_path, class_name, name, d, pic_file_type)
            process_1_i += 1


def ExtractFaceProcess(filename, dir, class_name, name, detector, pic_file_type):
    """
    ...
    ExtractFaceInsideJPG_Process(detector, jpg_dirpath, whole_jpg_path, class_name, name, pic_file_type)


def extractProcess(filename, dir, class_name, name, detector, pic_file_type):
    ExtractFaceProcess(filename, dir, class_name, name, detector, pic_file_type)